...
namespace Exercicios_AED1
{
    ...
    class Exercicio1
    {
        ...
        float[] GetNumbers()
        {
            ...
            Console.WriteLine("Please inform first number to get the sum (using comma as decimal separator)");
            numbersToSum[0] = float.Parse(Console.ReadLine());
            Console.WriteLine("Please inform second number to get the sum (using comma as decimal separator)");
